...
import type { RetryWarningDetailRecord, CustomerRepairDetailRecord, Page } from '../types'
...
export function RetryWarningDetailPage({ onNavigate }: { onNavigate: (p: Page) => void }) {
  // 重投预警清单
